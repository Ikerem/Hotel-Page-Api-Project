...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.AppUser", b =>
                {
                    ...
                    b.Property<string>("WorkDepartman")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.CategoreMessage", b =>
                {
                    b.Property<int>("MessageCategorid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("MessageCategorid");

                    b.ToTable("CategoreMessages");
                });

            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.Contect", b =>
                {
                    ...
                    b.Property<int?>("MessageCategoreMessageCategorid")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MessageCategoreMessageCategorid");
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.Services", b =>
                {
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.Contect", b =>
                {
                    b.HasOne("HotelProject.EntityLayer.Concrete.CategoreMessage", "MessageCategore")
                        .WithMany("Contects")
                        .HasForeignKey("MessageCategoreMessageCategorid");

                    b.Navigation("MessageCategore");
                });
