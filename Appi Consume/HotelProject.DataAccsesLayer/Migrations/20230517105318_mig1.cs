...
namespace HotelProject.DataAccsesLayer.Migrations
{
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CategoreMessages",
                columns: table => new
                {
                    MessageCategorid = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MessageName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoreMessages", x => x.MessageCategorid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Servicese", x => x.Serviceid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MessageCategorid = table.Column<int>(type: "int", nullable: false),
                    MessageCategoreMessageCategorid = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contects", x => x.Contectid);
                    table.ForeignKey(
                        name: "FK_Contects_CategoreMessages_MessageCategoreMessageCategorid",
                        column: x => x.MessageCategoreMessageCategorid,
                        principalTable: "CategoreMessages",
                        principalColumn: "MessageCategorid",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contects_MessageCategoreMessageCategorid",
                table: "Contects",
                column: "MessageCategoreMessageCategorid");
        }
